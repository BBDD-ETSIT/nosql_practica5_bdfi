...
![Architecture](https://raw.githubusercontent.com/ging/nosql_practica5_bdfi/blob/main/img/arquitectura.png)
...
El proyecto debe clonarse en el ordenador desde el que se está trabajando con:
    ...
    ```
    $ git clone https://github.com/BBDD-ETSIT/nosql_practica5_bdfi
    ```
